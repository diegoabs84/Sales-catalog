...
public class ResourceExceptionHandler {
	...
	@ExceptionHandler(ResourceNotFoundException.class)//sempre que algum dos seus controladores REST acontecer uma exceção desse tipo, esse método irá tratar dela
